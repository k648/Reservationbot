...
<ul>
    <li>A. Room Reservations</li>
    <li>B. View Amenities</li>
    <li>C. Special Offers</li>
    <li>D. Check-In Process</li>
    <li>E. Check-Out Process</li>
    <li>F. Contact</li>
    <li>G. FAQs</li>
    <li>H. Feedback</li>
    <li>I. Cancel</li>
    ...
    switch (session.step) {
      ...
      case 6: // User provides number of nights
        ...
        if (isNaN(nightsInput) || nightsInput <= 0) {
          ...
          responseMessage = `Your reservation for ${session.name} for ${session.suite}, from ${session.checkInDate} for ${session.nights} night(s) is confirmed! Thank you for choosing us!`;
